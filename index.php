        ...
        <div style="padding: 20px;text-align: center;position: relative;z-index: 10">
           <form method="POST" action="login_redirect.php"  novalidate onsubmit="return validate();">
             <div style="padding: 10px;background-color: #fff">
                 <img src="lohho.jpg" style="width:180px;">
              ...
              <!-- <div style="padding: 10px;"></div>-->
                ...
                <div class="row">
                  <div class="col-sm-12">
                   <button class="inputss hvr-bounce-to-right" name="login" style="width: 100%;background-color: #29a8e0">LogIn</button>
                  </div>
                </div>
                <br/>
          ...
          <div class="modal-content">
            <form method="POST" action="register_handle.php" novalidate onsubmit="return validate();">
             <div style="padding: 40px;background-color: #fff">
                  <center><img src="lohho.jpg" style="width:180px;"></center>
                ...
                <div class="row">
                  <div class="col-sm-12">
                   <button class="inputss  hvr-bounce-to-right" style="width: 100%;background-color:#29a8e0" type="submit" name="add_user">Register</button>
                  </div>
                </div>
