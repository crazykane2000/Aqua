                          ...
                          <div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab" aria-expanded="true">
                              <div style="padding: 10px;text-align: left;">
                                  ...
                                  <table class="table table-hover table-striped">
                                      ...
                                      <tbody style="font-size: 12px;">
                                          <tr>
                                              ...
                                              <td>Somewhere on earth is the Address.</td>
                                          </tr>
                                          <tr style="font-family: 'Didact Gothic', sans-serif;color: #444;font-size: 12px;">
                                              <td>Bank Address</td>
                                              <td>Somewhere on earth is the Address.</td>
                                          ...
                                          <tr>
                                              <td>Bank Name</td>
                                              <td>Community Aqua Savings Bank</td>
                                          </tr>
                                          <tr style="font-family: 'Didact Gothic', sans-serif;color: #444;font-size: 12px;">
                                              <td>Account No. </td>
                                              <td>8310445735989</td>
                                  ...
                                  <div style="padding: 10px;background-color: red;color: #fff;">
                                    <b>Note: Permitted countries of banks to receive USD funds are below. Please contact our support team if your bank doesn’t locate in these countries:</b>                                    Americas: United States, Canada. Asia: China, Hong Kong, India, Japan, Philippines, Singapore, Taiwan, United Arab Emirates. Oceania: Australia, New Zealand. Europe: 
                          ...
                          <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab" aria-expanded="false">
                              <div style="color: #444;">
                                <center>
                                  ...
                                  <br/>
                                  <br/>
                                  <b>Bitcoin Address</b> : 1EWTceugub9LC2vjXFYbCa1PpUdnYKcYJ1K
                                  <br/>
                                  <br/>
                          ...
                          <div class="tab-pane fade" id="gatar" role="tabpanel" aria-labelledby="gatar-tab" aria-expanded="false">
                              <div style="text-align: center;color: #333;">
                                  <center>
                                      ...
                                      <br/>
                                      <br/>
                                      <b>Ethereum Address</b> : 0x9489c2c2526090d69d1f394a1730661ea769d4027
                                      <br/>
                                      <br/>
                          ...
                          <div class="tab-pane fade" id="gatars" role="tabpanel" aria-labelledby="gatar-tab" aria-expanded="false">
                              <div style="text-align: center;color: #333;">
                                  <center>
                                      ...
                                      <br/>
                                      <br/>
                                      <b>USDT Address (Transfer network ERC20/Ethereum):</b> : 0xacc7013d075b50e2d041244e9fc8615cd27eb5006
                                      <br/>
                                      <br/>
                                      <div style="padding: 14px;background-color: red;width: 80%;color: #fff;">
