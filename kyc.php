            ...
            <div class="row">               
                ...
                <div class="col-xl-4 col-xs-12">
                    <div class="card-box items">
                      <div style="padding:10px"></div>               
                        ...
                        <a href="AQUA_SAFT.pdf" target="_blank" class="btn btn-danger" style="background-color: #58156d;border:0">Download SAFT Document</a> 
                        <div style="padding:20px"></div>
                       ...
                       <center>
                         <form method="POST" action="kyc_handle.php" enctype="multipart/form-data">
                           ...
                           <button class="btn btn-danger btn-lg" style="width: 100%;background-color: #58156d;border:0" type="sumbit" name="submit"  >UPLOAD SAFT DOCUMENTS</button>
                         </form>
                       </center>
                ...
                <div class="col-xl-4 col-xs-12">
                 ...
                 <div class="col-xl-4 col-xs-12">
                    <div class="card-box items">
                      <div style="padding: 10px;"></div>
                       <div class="century" style="font-size: 20px;color: #222"> KYC Documents Rules</div>
                          ...
                          <hr/>
                          <h3 style="color: #222;font-size:20px;">Purpose : </h3>
                          ...
                          <h3 style="color: #222;font-size:20px;">What can be used</h3>
