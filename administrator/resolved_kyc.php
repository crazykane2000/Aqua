<?php session_start();
   ...
   // Add User Starts Here
      ...
      $headers= "From: Contact Enquiry<website@AQUA.io>\r\n";
      $headers.= "Reply-To: KYC <kishan@AQUA.io>\r\n";
